      ...
      <section className="dp-main-content">
        <div className="dp-grid-3col" id="descripción">
          ...
          <div className="dp-col-center">
            <div className="dp-3d-box">
              <img src="/hero.png" alt="3D Animation" className="dp-3d-img" />
              <button className="dp-play-btn" aria-label="Play 3D Animation">
                <Play fill="currentColor" size={24} />
              </button>
            </div>
            <h4 className="dp-section-title" style={{ fontSize: 16, marginBottom: 8 }}>ANIMACIÓN EN 3D</h4>
            <p className="dp-3d-desc">{dino.videoText}</p>
          </div>
